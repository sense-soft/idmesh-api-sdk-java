...
public class TreeUser {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, treeUser.id) &&
        Objects.equals(this.developerId, treeUser.developerId) &&
        Objects.equals(this.tenantId, treeUser.tenantId) &&
        Objects.equals(this.nodeId, treeUser.nodeId) &&
        Objects.equals(this.userId, treeUser.userId) &&
        Objects.equals(this.path, treeUser.path) &&
        Objects.equals(this.displayName, treeUser.displayName) &&
        Objects.equals(this.username, treeUser.username) &&
        Objects.equals(this.relationType, treeUser.relationType) &&
        Objects.equals(this.relationData, treeUser.relationData) &&
        Objects.equals(this.isDefault, treeUser.isDefault) &&
        Objects.equals(this.timeCreated, treeUser.timeCreated) &&
        Objects.equals(this.timeModified, treeUser.timeModified) &&
        Objects.equals(this.status, treeUser.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, developerId, tenantId, nodeId, userId, path, displayName, username, relationType, relationData, isDefault, timeCreated, timeModified, status);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TreeUser {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to TreeUser
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TreeUser.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TreeUser is not found in the empty JSON string", TreeUser.openapiRequiredFields.toString()));
        }
      }


      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TreeUser.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TreeUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TreeUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TreeUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TreeUser.class));

       return (TypeAdapter<T>) new TypeAdapter<TreeUser>() {
           @Override
           public void write(JsonWriter out, TreeUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TreeUser read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TreeUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TreeUser
  * @throws IOException if the JSON string is invalid with respect to TreeUser
  */
  public static TreeUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TreeUser.class);
  }

 /**
  * Convert an instance of TreeUser to an JSON string
  *
  * @return JSON string
  */
