...
public class OrganizationTree {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    OrganizationTree organizationTree = (OrganizationTree) o;
    return Objects.equals(this.id, organizationTree.id) &&
        Objects.equals(this.objectDisplayName, organizationTree.objectDisplayName) &&
        Objects.equals(this.objectType, organizationTree.objectType) &&
        Objects.equals(this.objectCode, organizationTree.objectCode) &&
        Objects.equals(this.objectProps, organizationTree.objectProps) &&
        Objects.equals(this.isDefault, organizationTree.isDefault) &&
        Objects.equals(this.status, organizationTree.status) &&
        Objects.equals(this.timeCreated, organizationTree.timeCreated) &&
        Objects.equals(this.timeModified, organizationTree.timeModified) &&
        Objects.equals(this.type, organizationTree.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, objectDisplayName, objectType, objectCode, objectProps, isDefault, status, timeCreated, timeModified, type);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrganizationTree {\n");
  ...
  * @throws IOException if the JSON Element is invalid with respect to OrganizationTree
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrganizationTree.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrganizationTree is not found in the empty JSON string", OrganizationTree.openapiRequiredFields.toString()));
        }
      }


      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrganizationTree.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrganizationTree.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrganizationTree' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrganizationTree> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrganizationTree.class));

       return (TypeAdapter<T>) new TypeAdapter<OrganizationTree>() {
           @Override
           public void write(JsonWriter out, OrganizationTree value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public OrganizationTree read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of OrganizationTree given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrganizationTree
  * @throws IOException if the JSON string is invalid with respect to OrganizationTree
  */
  public static OrganizationTree fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrganizationTree.class);
  }

 /**
  * Convert an instance of OrganizationTree to an JSON string
  *
  * @return JSON string
  */
