...
public class UserRet {
  ...
  public static final String SERIALIZED_NAME_PASSWORD_LOCKED = "password_locked";
  @SerializedName(SERIALIZED_NAME_PASSWORD_LOCKED)
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserRet userRet = (UserRet) o;
    return Objects.equals(this.id, userRet.id) &&
        Objects.equals(this.username, userRet.username) &&
        Objects.equals(this.password, userRet.password) &&
        Objects.equals(this.displayName, userRet.displayName) &&
        Objects.equals(this.firstname, userRet.firstname) &&
        Objects.equals(this.lastname, userRet.lastname) &&
        Objects.equals(this.realname, userRet.realname) &&
        Objects.equals(this.pinyin, userRet.pinyin) &&
        Objects.equals(this.nickname, userRet.nickname) &&
        Objects.equals(this.userType, userRet.userType) &&
        Objects.equals(this.mobile, userRet.mobile) &&
        Objects.equals(this.email, userRet.email) &&
        Objects.equals(this.gender, userRet.gender) &&
        Objects.equals(this.certType, userRet.certType) &&
        Objects.equals(this.certNumber, userRet.certNumber) &&
        Objects.equals(this.region, userRet.region) &&
        Objects.equals(this.workTime, userRet.workTime) &&
        Objects.equals(this.workTitle, userRet.workTitle) &&
        Objects.equals(this.extProp, userRet.extProp) &&
        Objects.equals(this.arn, userRet.arn) &&
        Objects.equals(this.idProviderConnection, userRet.idProviderConnection) &&
        Objects.equals(this.developerId, userRet.developerId) &&
        Objects.equals(this.tenantId, userRet.tenantId) &&
        Objects.equals(this.lastLoginIpaddr, userRet.lastLoginIpaddr) &&
        Objects.equals(this.lastLoginTime, userRet.lastLoginTime) &&
        Objects.equals(this.timeCreated, userRet.timeCreated) &&
        Objects.equals(this.timeModified, userRet.timeModified) &&
        Objects.equals(this.status, userRet.status) &&
        Objects.equals(this.passwordLocked, userRet.passwordLocked);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, username, password, displayName, firstname, lastname, realname, pinyin, nickname, userType, mobile, email, gender, certType, certNumber, region, workTime, workTitle, extProp, arn, idProviderConnection, developerId, tenantId, lastLoginIpaddr, lastLoginTime, timeCreated, timeModified, status, passwordLocked);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserRet {\n");
    ...
    sb.append("    passwordLocked: ").append(toIndentedString(passwordLocked)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("password_locked");
  ...
  * @throws IOException if the JSON Element is invalid with respect to UserRet
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UserRet.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserRet is not found in the empty JSON string", UserRet.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserRet.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserRet' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserRet> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserRet.class));

       return (TypeAdapter<T>) new TypeAdapter<UserRet>() {
           @Override
           public void write(JsonWriter out, UserRet value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserRet read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserRet given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserRet
  * @throws IOException if the JSON string is invalid with respect to UserRet
  */
  public static UserRet fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserRet.class);
  }

 /**
  * Convert an instance of UserRet to an JSON string
  *
  * @return JSON string
  */
